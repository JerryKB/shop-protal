...
<!--        </div>-->
        ...
        <div class="orderListItem">
            <table oid="946" orderstatus="waitReview" class="orderListItemTable" style="display: table;" v-for="(o,index) in orders" :key="index">
                <tbody><tr class="orderListItemFirstTR">
                    <td colspan="2">
                        <b>{{o.order_createtime}}</b>
                ...
                <tr class="orderItemProductInfoPartTR">
                    <td class="orderItemProductInfoPartTD"><img width="80" height="80" :src="o.img_src"></td>
                    <td class="orderItemProductInfoPartTD">
                        <div class="orderListItemProductLinkOutDiv">
                            <a href="#nowhere">{{o.name}}</a>
                            <div class="orderListItemProductLinkInnerDiv">
                                <img title="支持信用卡支付" src="./images/creditcard.png">
                                <img title="消费者保障服务,承诺7天退货" src="./images/7day.png">
                                <img title="消费者保障服务,承诺如实描述" src="./images/promise.png">
                            </div>
                        </div>
                    </td>
                    <td width="100px" class="orderItemProductInfoPartTD">
<!--                        <div class="orderListItemProductOriginalPrice">￥2,499.00</div>-->
                        <div class="orderListItemProductPrice">￥{{o.product_price/o.product_count}}</div>
                    </td>
                    <td width="100px" valign="top" class="orderListItemNumberTD orderItemOrderInfoPartTD" rowspan="1">
                        <span class="orderListItemNumber">{{o.product_count}}</span>
                    </td>
                    <td width="120px" valign="top" class="orderListItemProductRealPriceTD orderItemOrderInfoPartTD" rowspan="1">
                        <div class="orderListItemProductRealPrice">￥{{o.product_price}}</div>
<!--                        <div class="orderListItemPriceWithTransport">(含运费：￥0.00)</div>-->
                    </td>
                    <td width="100px" valign="top" class="orderListItemButtonTD orderItemOrderInfoPartTD" rowspan="1">
                        <a href="#nowhere">
                            <button class="orderListItemConfirm">已付款</button>
                        </a>
                    </td>
                </tr>
                </tbody></table>
...
<script>
    export default {
        ...
        mounted() {
            ...
            this.getRequest('/order/getOrderByUserId/'+this.userInfo.id).then(data=>{
                this.orders = data;
            })
...
<style scoped>
    ...
    span.confirmPayOrderDetailWangWangGif {
        ...
        width: 67px;
        height: 22px;
        /*background-image: url(./images/wangwang.gif);*/
        background-repeat: no-repeat;
